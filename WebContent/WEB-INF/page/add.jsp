	...
	<div class="formDiv">
		<div class="top">
			<c:if test="${param.info==1 }">
				<span>学号重复了,请重新录入</span>
			</c:if>
		</div>
		<form action="/WebStudent/student/doadd" method="post">
			<input type="text" name="sno" placeholder="学号" /> <br />
			<br /> <input type="text" name="sname" placeholder="姓名" /> <br>
			<br /> <input type="text" name="sex" placeholder="性别" /> <br>
			<br /> <input type="text" name="address" placeholder="地址" /> <br>
